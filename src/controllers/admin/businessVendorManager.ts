...
const apiGet = [
    ...
    async (req: Request, res: Response) => {
        try {
            ...
            businessVendorManager.id = Number(vendorId);
...
const apiPost = [
    ...
    async (req: Request, res: Response) => {
        try {
            ...
            businessVendor.id = Number(vendorId);
...
const apiPatch = [
    ...
    async (req: Request, res: Response) => {
        ...
        for (const item of body) {
            ...
            const fieldType =
                businessVendorFieldManagerValueQuery.businessVendorField
                    .fieldType;
...
const apiDelete = [
    ...
    async (req: Request, res: Response) => {
        ...
        const businessVendorManager = new BusinessVendorManager();
        businessVendor.id = req.user.vendor.id;
        businessVendorManager.id = Number(req.params.managerId);
