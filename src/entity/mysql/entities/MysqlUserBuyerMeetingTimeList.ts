...
export class UserBuyerMeetingTimeList extends Base {
    ...
    @OneToOne(
        ...
        businessMeetingRoomReservation => businessMeetingRoomReservation.userBuyerMeetingTimeList,
    )
    businessMeetingRoomReservation: BusinessMeetingRoom;

    @ManyToOne(type => UserBuyer, userBuyer => userBuyer.userBuyerMeetingTimeLists, { nullable: true })
    userBuyer: UserBuyer;
}
