 ...
 */
@Entity()
export class BusinessVendorFieldManagerValueGroup extends Base {
  @OneToMany(
    type => BusinessVendorFieldManagerValue,
    BusinessVendorFieldManagerValue =>
      BusinessVendorFieldManagerValue.businessVendorFieldManagerValueGroup,
  )
  ...
  @OneToOne(type => User, user => user.businessVendorFieldManagerValueGroup)
  @JoinTable()
  user: User;

  @OneToOne(
    type => BusinessVendor,
    businessVendor => businessVendor.businessVendorFieldManagerValueGroup,
  )
  @JoinTable()
