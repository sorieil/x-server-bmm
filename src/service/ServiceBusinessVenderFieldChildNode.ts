...
export default class ServiceBusinessVenderFieldChildNode extends BaseService {
    ...
    public async post(childNode: BusinessVenderFieldChildNode) {
        const query = this.mysqlManager(BusinessVenderFieldChildNode).save(childNode);
        return query;
    }

    public async delete(businessVenderFieldChildNode: BusinessVenderFieldChildNode) {
        const query = this.mysqlManager(BusinessVenderFieldChildNode).delete(businessVenderFieldChildNode);
