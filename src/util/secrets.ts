...
if (!MYSQL_DATABASE || !MONGODB_URI) {
    logger.error('No client mysql or mongodb connection information. Set MYSQL NODE_ENV variable.');
    process.exit(1);
}

if (!MYSQL_DATABASE) {
    logger.error('No client mysql connection information. Set MYSQL NODE_ENV variable.');
    process.exit(1);
}
